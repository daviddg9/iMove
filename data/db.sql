...
CREATE TABLE STOP_ROUTES(
    ...
    CONSTRAINT FK_STOP_ROUTES_STOP_ID FOREIGN KEY (STOP_ID) REFERENCES STOPS(STOP_ID),
    CONSTRAINT FK_STOP_ROUTES_ROUTE_ID FOREIGN KEY (ROUTE_ID) REFERENCES ROUTES(ROUTE_ID)
);
